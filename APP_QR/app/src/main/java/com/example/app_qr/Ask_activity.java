...
public class Ask_activity extends AppCompatActivity {
    ...
    private Ask getAsk() {
        ...
        int askNumber = randomNumber.nextInt(asksList.size()-1);
        ...
        Log.d("randomNumber","getAask()" + AskAuxiliar.askDoneList.size());

        while(AskAuxiliar.askDoneList.contains(randomAsk)){
            askNumber = randomNumber.nextInt(3);
